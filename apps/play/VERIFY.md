...
- Unit: 467 across the workspace (239 core, 96 recognition, 55
  platform-web, 77 apps/play). Recognition includes the worker/module
...
- Integration (`test/integration/run.mjs`): 68 checks driving the built
