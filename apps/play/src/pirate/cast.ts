...
export const PIRATES: readonly Pirate[] = [
  {
    ...
    taunts: {
      ...
      parata: ["Parata! Ni tu ni jo!", "Empat! Com ahir amb el cuiner!"],
  ...
  },
  {
    ...
    taunts: {
      ...
      parata: ["Empat. El vent decidirà.", "Parata! Així m'agrada, de tu a tu."],
  ...
  },
  {
    ...
    taunts: {
      ...
      parata: ["Parata. Com als vells temps.", "Empat. El mar riu, quan passa això."],
